<hgroup>
    <h3 class="aligner txtGras">Catalogue de Films</h3>
...
if (!isset($_GET['id_film'])) {
    print "<p><br/><span class='txtGras'>Pour commander, choisissez <a href='index.php?page=films.php'>ici</a> votre article</span></p>";
} else {
    print "<br/>Afficher ici le rappel du produit commandé<br/><br/>";
    ?>
    <div class="row">
        <div class="col-xs-4 col-sm-2">
            <img src="./admin/images/equalizer.jpg" alt="Votre commande"/> [cette image doit être dynamique]
        </div>
    ...
    <div class="container">
        ...
        <form action="<?php print $_SERVER['PHP_SELF']; ?>" method="get" id="form_commande">
            ...
            <br/>
                    <input type="hidden" name="id_commande" value="<?php print $_GET['id_film']; ?>"/>
